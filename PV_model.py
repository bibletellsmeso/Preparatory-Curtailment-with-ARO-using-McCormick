...
class Photovoltaic:
    def __init__(self):
        ...
        self.Weather_Forecast = np.genfromtxt('/Users/Andrew/OneDrive - GIST/Code/C&CG TSRO/ro/data/Hawaii weather.csv', delimiter=',', skip_header=1, dtype=np.float32)
        self.real_PV = np.loadtxt("/Users/Andrew/OneDrive - GIST/Code/C&CG TSRO/ro/data/PV_for_scheduling.txt")
